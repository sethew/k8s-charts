...
app.kubernetes.io/name: {{ include "enshrouded-server.name" . }}
...
*/}}
{{- define "enshrouded-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "enshrouded-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
